package com.debeziumtest.config;

import cn.hutool.core.io.FileUtil;
import com.debeziumtest.entity.handler.ChangeEventHandler;
...
public class DebeziumConfig {
    ...
    @Autowired
    public void setChangeEventConfig(ChangeEventHandler changeEventHandler) {
